...
class EditForm extends Component {
    ...
    render() {
        ...
        let renderRadio = (question,student_id,num,handleRadio) => {
            if (question === true) {
              return (
                  <p>
                    <label>
                      <input class="with-gap" name={String(student_id+num)} onClick={handleRadio} type="radio" checked />
                      <span></span>
                    </label>
                  </p>
              );
              ...
              return (
                <p>
                 <label>
                    <input class="with-gap" name={String(student_id+num)} onClick={handleRadio} type="radio" 
          ...
          let renderCheckbox = (question,student_id,num,handleCheckbox) => {
            if (question === true) {
              return (
                <input class="with-gap" name={String(student_id+num)} onClick={handleCheckbox}   type="checkbox" checked="checked"  />
              );
            }
            else {
              return (
                <input class="with-gap" name={String(student_id+num)} onClick={handleCheckbox}   type="checkbox"  />
              );
            }
          };
        return (
            ...
            <h6>
              ...
              <h6>
                <div class="row">
                  ...
                  <div class="col s6">
                    <input value={this.state.class} id="class" placeholder="VD: Công nghệ thông tin - 01 - K61" onChange={(e)=>this.handleChange(e)}  type="text" class="validate"/>
                    <label for="class">Lớp</label>
                  </div>
                  <div class="col s1"></div>
                  <div class="col s1"><div class="row"></div>MSSV: </div>
                  <div class="col s2">                    
                    <input value={this.state.student_id} id="student_id" placeholder="VD: 20169283" onChange={(e)=>this.handleChange(e)}  type="text" class="validate"/>
                    </div>
                </div>
              </h6>
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      {renderRadio(this.state.question1.a1,this.state.student_id,1,(e)=>this.handleEditQ1Yes(e))}
                    </td>
                    <td>
                      {renderRadio(this.state.question1.a2,this.state.student_id,1,(e)=>this.handleEditQ1No(e))}
                    </td>
                  </tr>
                  <tr>
                    <td><h6>Có tiếp xúc với người bệnh hoặc nghi ngờ mắc bệnh COVID-19</h6></td>
                    <td>
                      {renderRadio(this.state.question2.a1,this.state.student_id,2,(e)=>this.handleEditQ2Yes(e))}
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>
                     {renderRadio(this.state.question3.a1,this.state.student_id,3,(e)=>this.handleEditQ3Yes(e))}
                    
                    </td>
                    <td>
                    {renderRadio(this.state.question3.a2,this.state.student_id,3,(e)=>this.handleEditQ3No(e))}
              ...
              <div class="row">
                    ...
                    <div class="col s11" >  
                      <p>
                        <label>
                          {renderCheckbox(this.state.question4.a1,this.state.student_id,4,(e)=>this.handleEditQ4A1(e))}
                          <span>Sốt</span>
                        </label>
                      </p> 
                      <p>
                        <label>
                        {renderCheckbox(this.state.question4.a2,this.state.student_id,4,(e)=>this.handleEditQ4A2(e))}
                          <span>Ho</span>
                        </label>
                      </p>
                      <p>
                        <label>
                        {renderCheckbox(this.state.question4.a3,this.state.student_id,4,(e)=>this.handleEditQ4A3(e))}
                          <span>Khó thở</span>
                        </label>
                      </p>
                    </div>
